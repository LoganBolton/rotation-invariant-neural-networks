...
HIPPYNN_INVARIANTS_REF="${HIPPYNN_INVARIANTS_REF:-lmax_4_nmax_7}"
OUTPUT_DIR="${OUTPUT_DIR:-benchmarks/rotating_ring/results/z_rotation_radius1_no_gap_l4_n7_all_sizes}"
...
echo "Model: HIP-HOP l_max=4 n_max=7"
