...
HIPPYNN_SOURCE_ROOT="${HIPPYNN_SOURCE_ROOT:-/vast/home/logan_bolton/Github/hippynn-lmax4-nmax5-flexible}"
OUTPUT_DIR="${OUTPUT_DIR:-benchmarks/rotating_ring/results/2d_l3_l4_n3to5_cutoff7_equal_radius_local}"
